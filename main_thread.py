...
rate,refaudio=wavfile.read("C:/Users/kashv/Capstone_Group19/Capstone-Group-19/riptide.wav")
        ...
        try:
            ...
            if chordsls.qsize()>0:
                for i in range(chordsls.qsize()):
                    ...
                    #print("===========================================")
                    chordsls.get()
                    cleanInput(chordsls.get())
                    cleanInput()
                    #figure out waht type actual is and how to make sure it lines up ykwim
                    #time.sleep(.01)
